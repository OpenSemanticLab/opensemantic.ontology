...
Welcome to `opensemantic.ontology` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.ontology`, please have a look
...
You can help improve `opensemantic.ontology` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.ontology` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.ontology`'s files. While this mechanism can
...
```
conda create -n opensemantic.ontology python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.ontology
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.ontology.git
   cd opensemantic.ontology
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.ontology` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.ontology
[issue tracker]: https://github.com/<USERNAME>/opensemantic.ontology/issues
